...
class Application extends Container {
	...
	configureDefaultPaths() {
		...
		this.configurePaths({
			...
			'controller': path.join(basePath, 'app', 'http', 'controllers'),
			'command':    path.join(basePath, 'app', 'command'),
	...
	flush() {
		...
		eventEmitter.removeAllListeners('application.booting');
		eventEmitter.removeAllListeners('application.booted');
