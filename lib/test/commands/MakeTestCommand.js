...
class MakeTestCommand extends GeneratorCommand {
	...
	static get dependencies() {
		return (super.dependencies || []).concat(['test.type', 'helper.string']);
	}
	...
	get patterns() {
		return {
			TEST_CASE_PATH: this.app.formatPath(path.relative(path.dirname(this.getDestination()), this.app.testPath('TestCase.js')))
		};
	}
