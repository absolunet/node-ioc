...
class ConfigGrammar {
  ...
  get pipeline() {
    return ['formatEnvironment', 'formatPath'];
  }
  /**
  ...
  get replacements() {
    return {
      path: [{
        search: /^@\//u,
        replace: `${this.app.basePath()}/`
      }, {
        search: /^~\//u,
        replace: `${this.app.homePath()}/`
      }],
      environment: [{
  ...
  replaceValue(value, type) {
    return this.evaluator.evaluate(this.replacements[type].reduce((text, {
      search,
      replace
    }) => {
