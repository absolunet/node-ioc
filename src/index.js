...
module.exports = {
	get Application() {             return require('./foundation/Application').default; },
	get BaseProxy() {               return require('./support/proxies/BaseProxy').default; },
	get Controller() {              return require('./http/controllers/Controller').default; },
	...
	get Migration() {               return require('./database/Migration').default; },
	get Model() {                   return require('./database/Model').default; },
	get ModelFactory() {            return require('./database/Factory').default; },
	get ApplicationBootingError() { return require('./foundation/exceptions/ApplicationBootingError').default; },
